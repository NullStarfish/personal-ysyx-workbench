...
void VTop_Top____Vdpiimwrap_controller_unit__DOT__ebreak_TOP__Top();
...
VL_INLINE_OPT void VTop_Top___ico_sequent__TOP__Top__0(VTop_Top* vlSelf) {
    ...
    vlSelf->__PVT__reg_rs2_data = ((0U == (IData)(vlSelf->__PVT__rs2))
    ...
    vlSelf->__PVT__pc_unit__DOT__PCin = ((IData)(vlSelf->__PVT__PCSel)
                                          ...
                                          : ((IData)(4U) 
                                             + vlSelf->pc_out));
    vlSelf->__PVT__wb_data = ((0U == (IData)(vlSelf->__PVT__WBSel))
                               ? vlSelf->__PVT__dmem_rdata
                               : ((1U == (IData)(vlSelf->__PVT__WBSel))
                                   ? vlSelf->__PVT__alu_result
                                   : ((2U == (IData)(vlSelf->__PVT__WBSel))
                                       ? ((IData)(4U) 
                                          + vlSelf->pc_out)
                                       : 0xdeadbeefU)));
}
