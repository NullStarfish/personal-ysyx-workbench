...
module Queue1_AXI4BundleA(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
    ...
    if (do_enq)	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
      ram <= {1'h0, io_enq_bits_addr, 25'h9010};	// src/main/scala/chisel3/util/Queue.scala:73:91
  end // always @(posedge)
  ...
  assign io_deq_bits_addr = ram[56:25];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
