...
module Queue2_ExecutePacket(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input         io_enq_bits_ctrl_op1Sel,	// src/main/scala/chisel3/util/Queue.scala:72:14
                ...
                io_enq_bits_redirect,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  wire [170:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  ram_2x171 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    .W0_data
      ({io_enq_bits_pc,
        ...
        io_enq_bits_ctrl_memFunct3})	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_pc = _ram_ext_R0_data[170:139];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_inst = _ram_ext_R0_data[138:107];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_dnpc = _ram_ext_R0_data[106:75];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_aluResult = _ram_ext_R0_data[74:43];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_memWData = _ram_ext_R0_data[42:11];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_rdAddr = _ram_ext_R0_data[10:6];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_regWen = _ram_ext_R0_data[5];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_memEn = _ram_ext_R0_data[4];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_memWen = _ram_ext_R0_data[3];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_memFunct3 = _ram_ext_R0_data[2:0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
