...
module Top(	// src/main/scala/mycpu/Top.scala:9:7
  ...
  wire        _xbar_io_slaves_1_b_ready;	// src/main/scala/mycpu/Top.scala:15:25
  ...
  wire [1:0]  _arbiter_io_ifu_r_bits_resp;	// src/main/scala/mycpu/Top.scala:14:25
  ...
  wire [1:0]  _arbiter_io_lsu_r_bits_resp;	// src/main/scala/mycpu/Top.scala:14:25
  ...
  Core core (	// src/main/scala/mycpu/Top.scala:13:25
    ...
    .io_imem_r_bits_resp  (_arbiter_io_ifu_r_bits_resp),	// src/main/scala/mycpu/Top.scala:14:25
    ...
    .io_dmem_r_bits_resp  (_arbiter_io_lsu_r_bits_resp),	// src/main/scala/mycpu/Top.scala:14:25
  ...
  SimpleAXIArbiter arbiter (	// src/main/scala/mycpu/Top.scala:14:25
    ...
    .io_ifu_ar_valid     (_core_io_imem_ar_valid),	// src/main/scala/mycpu/Top.scala:13:25
    .io_ifu_ar_bits_addr (_core_io_imem_ar_bits_addr),	// src/main/scala/mycpu/Top.scala:13:25
    .io_ifu_r_ready      (_core_io_imem_r_ready),	// src/main/scala/mycpu/Top.scala:13:25
    ...
    .io_lsu_ar_valid     (_core_io_dmem_ar_valid),	// src/main/scala/mycpu/Top.scala:13:25
    .io_lsu_ar_bits_addr (_core_io_dmem_ar_bits_addr),	// src/main/scala/mycpu/Top.scala:13:25
    .io_lsu_r_ready      (_core_io_dmem_r_ready),	// src/main/scala/mycpu/Top.scala:13:25
    ...
    .io_lsu_aw_valid     (_core_io_dmem_aw_valid),	// src/main/scala/mycpu/Top.scala:13:25
    .io_lsu_aw_bits_addr (_core_io_dmem_aw_bits_addr),	// src/main/scala/mycpu/Top.scala:13:25
    .io_lsu_w_ready      (_arbiter_io_lsu_w_ready),
    .io_lsu_w_valid      (_core_io_dmem_w_valid),	// src/main/scala/mycpu/Top.scala:13:25
    .io_lsu_w_bits_data  (_core_io_dmem_w_bits_data),	// src/main/scala/mycpu/Top.scala:13:25
    .io_lsu_w_bits_strb  (_core_io_dmem_w_bits_strb),	// src/main/scala/mycpu/Top.scala:13:25
    .io_lsu_b_ready      (_core_io_dmem_b_ready),	// src/main/scala/mycpu/Top.scala:13:25
    .io_lsu_b_valid      (_arbiter_io_lsu_b_valid),
    .io_mem_ar_ready     (_xbar_io_in_ar_ready),	// src/main/scala/mycpu/Top.scala:15:25
    ...
    .io_mem_r_valid      (_xbar_io_in_r_valid),	// src/main/scala/mycpu/Top.scala:15:25
    .io_mem_r_bits_data  (_xbar_io_in_r_bits_data),	// src/main/scala/mycpu/Top.scala:15:25
    .io_mem_r_bits_resp  (_xbar_io_in_r_bits_resp),	// src/main/scala/mycpu/Top.scala:15:25
    .io_mem_aw_ready     (_xbar_io_in_aw_ready),	// src/main/scala/mycpu/Top.scala:15:25
    .io_mem_aw_valid     (_arbiter_io_mem_aw_valid),
    .io_mem_aw_bits_addr (_arbiter_io_mem_aw_bits_addr),
    .io_mem_w_ready      (_xbar_io_in_w_ready),	// src/main/scala/mycpu/Top.scala:15:25
    ...
    .io_mem_b_valid      (_xbar_io_in_b_valid)	// src/main/scala/mycpu/Top.scala:15:25
  );	// src/main/scala/mycpu/Top.scala:14:25
  Xbar xbar (	// src/main/scala/mycpu/Top.scala:15:25
    .clock                    (clock),
    .reset                    (reset),
    .io_in_ar_ready           (_xbar_io_in_ar_ready),
    .io_in_ar_valid           (_arbiter_io_mem_ar_valid),	// src/main/scala/mycpu/Top.scala:14:25
    .io_in_ar_bits_addr       (_arbiter_io_mem_ar_bits_addr),	// src/main/scala/mycpu/Top.scala:14:25
    .io_in_r_ready            (_arbiter_io_mem_r_ready),	// src/main/scala/mycpu/Top.scala:14:25
    ...
    .io_in_aw_valid           (_arbiter_io_mem_aw_valid),	// src/main/scala/mycpu/Top.scala:14:25
    .io_in_aw_bits_addr       (_arbiter_io_mem_aw_bits_addr),	// src/main/scala/mycpu/Top.scala:14:25
    .io_in_w_ready            (_xbar_io_in_w_ready),
    .io_in_w_valid            (_arbiter_io_mem_w_valid),	// src/main/scala/mycpu/Top.scala:14:25
    .io_in_w_bits_data        (_arbiter_io_mem_w_bits_data),	// src/main/scala/mycpu/Top.scala:14:25
    .io_in_w_bits_strb        (_arbiter_io_mem_w_bits_strb),	// src/main/scala/mycpu/Top.scala:14:25
    .io_in_b_ready            (_arbiter_io_mem_b_ready),	// src/main/scala/mycpu/Top.scala:14:25
  ...
  Serial serial (	// src/main/scala/mycpu/Top.scala:17:25
    ...
    .io_bus_b_ready      (_xbar_io_slaves_1_b_ready),	// src/main/scala/mycpu/Top.scala:15:25
