...
module AXI4LiteReadSlaveBridge(	// src/main/scala/mycpu/utils/AXI4LiteSlaveBridges.scala:12:7
  ...
  output [31:0] io_axi_r_bits_data,	// src/main/scala/mycpu/utils/AXI4LiteSlaveBridges.scala:13:14
  output        io_req_valid,	// src/main/scala/mycpu/utils/AXI4LiteSlaveBridges.scala:13:14
  input         io_resp_valid,	// src/main/scala/mycpu/utils/AXI4LiteSlaveBridges.scala:13:14
  input  [31:0] io_resp_bits_rdata	// src/main/scala/mycpu/utils/AXI4LiteSlaveBridges.scala:13:14
);
  ...
  assign io_axi_r_bits_data = io_resp_bits_rdata;	// src/main/scala/mycpu/utils/AXI4LiteSlaveBridges.scala:12:7
endmodule
