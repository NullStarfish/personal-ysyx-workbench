...
module Queue1_SimpleReadBusResp(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [31:0] io_enq_bits_rdata,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input         io_enq_bits_isError,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output        io_deq_bits_isError	// src/main/scala/chisel3/util/Queue.scala:72:14
);

  reg [32:0] ram;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
    ...
    if (do_enq)	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
      ram <= {io_enq_bits_rdata, io_enq_bits_isError};	// src/main/scala/chisel3/util/Queue.scala:73:91
  end // always @(posedge)
  ...
  assign io_deq_bits_rdata = ram[32:1];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_isError = ram[0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
