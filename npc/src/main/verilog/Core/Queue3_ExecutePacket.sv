...
module Queue3_ExecutePacket(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input         io_enq_bits_ctrl_op1Sel,	// src/main/scala/chisel3/util/Queue.scala:72:14
                ...
                io_enq_bits_redirect_valid,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input  [31:0] io_enq_bits_redirect_bits,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  ram_3x249 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    .W0_data
      ({io_enq_bits_pc,
        ...
        io_enq_bits_redirect_valid,
        io_enq_bits_redirect_bits})	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_pc = _ram_ext_R0_data[248:217];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_inst = _ram_ext_R0_data[216:185];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_dnpc = _ram_ext_R0_data[184:153];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_aluResult = _ram_ext_R0_data[152:121];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_memWData = _ram_ext_R0_data[120:89];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_pcTarget = _ram_ext_R0_data[88:57];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_rdAddr = _ram_ext_R0_data[56:52];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_aluOp = _ram_ext_R0_data[51:48];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_csrOp = _ram_ext_R0_data[47:46];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_regWen = _ram_ext_R0_data[45];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_memEn = _ram_ext_R0_data[44];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_memWen = _ram_ext_R0_data[43];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_memFunct3 = _ram_ext_R0_data[42:40];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_op1Sel = _ram_ext_R0_data[39];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_op2Sel = _ram_ext_R0_data[38];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_isJump = _ram_ext_R0_data[37];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_isBranch = _ram_ext_R0_data[36];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_isEcall = _ram_ext_R0_data[35];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_ctrl_isMret = _ram_ext_R0_data[34];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
