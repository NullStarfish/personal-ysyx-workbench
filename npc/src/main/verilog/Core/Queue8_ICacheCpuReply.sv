...
module Queue8_ICacheCpuReply(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input         io_enq_bits_hit,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output [31:0] io_deq_bits_inst,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input         io_flush	// src/main/scala/chisel3/util/Queue.scala:72:14
);

  wire [31:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
    if (reset) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      maybe_full <= ~io_flush & (do_enq == do_deq ? maybe_full : do_enq);	// src/main/scala/chisel3/util/Queue.scala:76:27, :80:27, :81:27, :93:{15,27}, :94:16, :96:15, :99:16, :115:17, :117:14, :118:{26,35}, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    end
  end // always @(posedge)
  ram_8x32 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_inst = empty ? io_enq_bits_inst : _ram_ext_R0_data;	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91, :78:25, :110:17, :115:17, :116:19
endmodule
