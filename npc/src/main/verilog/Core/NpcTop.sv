module NpcTop(
  ...
  NpcVirtualAxiRam ram (
    .clock(clock),
    .reset(reset),
    .aw_valid(master_awvalid),
    .aw_ready(master_awready),
    .aw_addr(master_awaddr),
    .aw_id(master_awid),
    .w_valid(master_wvalid),
    .w_ready(master_wready),
    .w_data(master_wdata),
    .w_strb(master_wstrb),
    .b_valid(master_bvalid),
    .b_ready(master_bready),
    .b_resp(master_bresp),
    .b_id(master_bid),
    .ar_valid(master_arvalid),
    .ar_ready(master_arready),
    .ar_addr(master_araddr),
    .ar_id(master_arid),
    .r_valid(master_rvalid),
    .r_ready(master_rready),
    .r_resp(master_rresp),
    .r_data(master_rdata),
    .r_last(master_rlast),
    .r_id(master_rid)
