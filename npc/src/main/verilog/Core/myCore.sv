...
module myCore(	// src/main/scala/mycpu/CoreWrapper.scala:14:7
  ...
  wire [2:0] _core_io_master_aw_bits_id;	// src/main/scala/mycpu/CoreWrapper.scala:102:20
  wire [2:0] _core_io_master_ar_bits_id;	// src/main/scala/mycpu/CoreWrapper.scala:102:20
  Core core (	// src/main/scala/mycpu/CoreWrapper.scala:102:20
    ...
    .io_master_r_bits_id     (io_master_rid[2:0]),	// src/main/scala/mycpu/CoreWrapper.scala:157:30
  ...
  assign io_master_awid = {1'h0, _core_io_master_aw_bits_id};	// src/main/scala/mycpu/CoreWrapper.scala:14:7, :102:20, :117:21
  assign io_master_arid = {1'h0, _core_io_master_ar_bits_id};	// src/main/scala/mycpu/CoreWrapper.scala:14:7, :102:20, :146:21
