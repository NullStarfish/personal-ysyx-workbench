...
module LSU(	// src/main/scala/mycpu/core/backend/LSU.scala:9:7
  ...
  input  [31:0] io_in_bits_retire_pc,	// src/main/scala/mycpu/core/backend/LSU.scala:10:14
                io_in_bits_retire_dnpc,	// src/main/scala/mycpu/core/backend/LSU.scala:10:14
                io_in_bits_retire_inst,	// src/main/scala/mycpu/core/backend/LSU.scala:10:14
  ...
  output [31:0] io_out_bits_retire_pc,	// src/main/scala/mycpu/core/backend/LSU.scala:10:14
                io_out_bits_retire_dnpc,	// src/main/scala/mycpu/core/backend/LSU.scala:10:14
                io_out_bits_retire_inst,	// src/main/scala/mycpu/core/backend/LSU.scala:10:14
  ...
  reg  [31:0] reqReg_retire_pc;	// src/main/scala/mycpu/core/backend/LSU.scala:28:19
  reg  [31:0] reqReg_retire_dnpc;	// src/main/scala/mycpu/core/backend/LSU.scala:28:19
  reg  [31:0] reqReg_retire_inst;	// src/main/scala/mycpu/core/backend/LSU.scala:28:19
  ...
  wire        _GEN_0 = reqView_mem_subop == 3'h1;	// src/main/scala/mycpu/core/backend/LSU.scala:31:11, :32:30, :33:13, :43:29
  wire [38:0] _writeData_T_2 =
    {31'h0, reqView_rhs[7:0]} << {34'h0, memReq_addr[1:0], 3'h0};	// src/main/scala/mycpu/core/backend/LSU.scala:31:11, :32:30, :33:13, :37:24, :46:{31,38}
  wire        _GEN_1 = reqView_mem_subop == 3'h2;	// src/main/scala/mycpu/core/backend/LSU.scala:31:11, :32:30, :33:13, :43:29
  wire [4:0]  _writeStrb_T_1 = 5'h3 << memReq_addr[1:0];	// src/main/scala/mycpu/core/backend/LSU.scala:31:11, :32:30, :33:13, :37:24, :50:30
  wire [46:0] _writeData_T_5 =
    {31'h0, reqView_rhs[15:0]} << {42'h0, memReq_addr[1:0], 3'h0};	// src/main/scala/mycpu/core/backend/LSU.scala:31:11, :32:30, :33:13, :37:24, :46:38, :51:{31,39}
  wire        _GEN_2 = reqView_mem_subop == 3'h3;	// src/main/scala/mycpu/core/backend/LSU.scala:31:11, :32:30, :33:13, :43:29
  ...
  wire [31:0] shiftedReadData =
    _readBridge_io_rStream_bits_data >> {27'h0, memReq_addr[1:0], 3'h0};	// src/main/scala/mycpu/core/backend/LSU.scala:17:26, :31:11, :32:30, :33:13, :37:24, :77:57
  ...
  wire        io_in_ready_0 =
    ...
    & (~io_in_bits_mem_valid | isInputLoad & _readBridge_io_rReq_ready | isInputStore
       & _writeBridge_io_wReq_ready & _writeBridge_io_wStream_ready);	// src/main/scala/mycpu/core/backend/LSU.scala:17:26, :18:27, :32:14, :92:32, :93:33, :94:28, :96:15, :114:17, :117:36, :118:{38,67}, :120:{19,40,54}
  wire        writeBridge_io_wReq_valid = _GEN & io_in_valid & isInputStore;	// src/main/scala/mycpu/core/backend/LSU.scala:32:14, :93:33, :105:29, :114:17, :134:{33,48}
  wire        _GEN_3 = state == 2'h1;	// src/main/scala/mycpu/core/backend/LSU.scala:27:22, :111:35, :114:17
  wire        _GEN_4 = state == 2'h2;	// src/main/scala/mycpu/core/backend/LSU.scala:27:22, :114:17
  wire        io_out_valid_0 =
    ~_GEN
    & (_GEN_3
         ? _readBridge_io_rStream_valid
         : _GEN_4 ? _writeBridge_io_bResp_valid : (&state));	// src/main/scala/mycpu/core/backend/LSU.scala:17:26, :18:27, :27:22, :32:14, :97:16, :104:31, :114:17, :139:20, :147:20
  always @(posedge clock) begin	// src/main/scala/mycpu/core/backend/LSU.scala:9:7
    ...
    if (reset)	// src/main/scala/mycpu/core/backend/LSU.scala:9:7
      ...
      if (_GEN_5)	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
        state <= io_in_bits_mem_valid ? (isInputLoad ? 2'h1 : 2'h2) : 2'h3;	// src/main/scala/mycpu/core/backend/LSU.scala:27:22, :92:32, :111:35, :124:34, :125:17, :126:33, :127:17, :129:17
    end
    else if ((_GEN_3 | _GEN_4 | (&state)) & io_out_valid_0)	// src/main/scala/mycpu/core/backend/LSU.scala:27:22, :97:16, :114:17, :141:25, :142:15, :149:25, :156:25, :157:15
      state <= 2'h0;	// src/main/scala/mycpu/core/backend/LSU.scala:27:22
    if (_GEN & _GEN_5) begin	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35, src/main/scala/mycpu/core/backend/LSU.scala:28:19, :32:14, :114:17, :122:24, :123:16
      ...
      reqReg_retire_pc <= io_in_bits_retire_pc;	// src/main/scala/mycpu/core/backend/LSU.scala:28:19
      reqReg_retire_dnpc <= io_in_bits_retire_dnpc;	// src/main/scala/mycpu/core/backend/LSU.scala:28:19
      reqReg_retire_inst <= io_in_bits_retire_inst;	// src/main/scala/mycpu/core/backend/LSU.scala:28:19
    end
  end // always @(posedge)
  AXI4ReadBridge readBridge (	// src/main/scala/mycpu/core/backend/LSU.scala:17:26
    ...
    .io_rReq_valid        (_GEN & io_in_valid & isInputLoad),	// src/main/scala/mycpu/core/backend/LSU.scala:32:14, :92:32, :102:28, :114:17, :133:{32,47}
    ...
    .io_rStream_ready     (~_GEN & _GEN_3),	// src/main/scala/mycpu/core/backend/LSU.scala:32:14, :104:31, :114:17
  ...
  AXI4WriteBridge writeBridge (	// src/main/scala/mycpu/core/backend/LSU.scala:18:27
    ...
    .io_wStream_bits_data
      (_GEN_0
         ? _writeData_T_2[31:0]
         : _GEN_1 ? _writeData_T_5[31:0] : _GEN_2 ? reqView_rhs : 32'h0),	// src/main/scala/mycpu/core/backend/LSU.scala:31:11, :32:30, :33:13, :40:30, :43:29, :46:{17,38}, :51:{17,39}, :56:17
    .io_wStream_bits_strb
      (_GEN_0 ? 4'h1 << memReq_addr[1:0] : _GEN_1 ? _writeStrb_T_1[3:0] : {4{_GEN_2}}),	// src/main/scala/mycpu/core/backend/LSU.scala:31:11, :32:30, :33:13, :37:24, :39:30, :43:29, :45:{17,30}, :50:{17,30}, :55:17
    .io_bResp_ready       (~(_GEN | _GEN_3) & _GEN_4),	// src/main/scala/mycpu/core/backend/LSU.scala:32:14, :109:30, :114:17
  ...
  assign io_in_ready = io_in_ready_0;	// src/main/scala/mycpu/core/backend/LSU.scala:9:7, :96:15, :114:17, :120:19
  assign io_out_valid = io_out_valid_0;	// src/main/scala/mycpu/core/backend/LSU.scala:9:7, :97:16, :114:17
  assign io_out_bits_wbData =
    reqReg_mem_valid & ~reqReg_mem_write
      ...
      : reqReg_result;	// src/main/scala/mycpu/core/backend/LSU.scala:9:7, :17:26, :28:19, :77:57, :79:28, :81:{16,22,59,70,95}, :84:{16,22,59,71,96}, :98:{28,46,49}
  ...
  assign io_out_bits_retire_pc = reqReg_retire_pc;	// src/main/scala/mycpu/core/backend/LSU.scala:9:7, :28:19
  assign io_out_bits_retire_dnpc = reqReg_retire_dnpc;	// src/main/scala/mycpu/core/backend/LSU.scala:9:7, :28:19
  assign io_out_bits_retire_inst = reqReg_retire_inst;	// src/main/scala/mycpu/core/backend/LSU.scala:9:7, :28:19
  ...
  assign io_status_pendingLoad = state == 2'h1 & reqReg_mem_valid & ~reqReg_mem_write;	// src/main/scala/mycpu/core/backend/LSU.scala:9:7, :27:22, :28:19, :98:49, :111:{35,59,79}
