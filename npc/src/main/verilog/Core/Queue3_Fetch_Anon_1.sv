...
module Queue3_Fetch_Anon_1(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [1:0]  io_enq_bits_epoch,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output [1:0]  io_deq_bits_epoch	// src/main/scala/chisel3/util/Queue.scala:72:14
);
  ...
  ram_3x34 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_pc = _ram_ext_R0_data[33:2];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_epoch = _ram_ext_R0_data[1:0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
