...
module Queue2_FetchPacket(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [31:0] io_enq_bits_inst,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  ram_inst_2x32 ram_inst_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    .R0_addr (deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40
    .R0_en   (1'h1),	// src/main/scala/chisel3/util/Queue.scala:60:7
    .R0_clk  (clock),
    .R0_data (io_deq_bits_inst),
