...
module Queue4_FetchMeta(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input         io_enq_bits_epoch,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output        io_deq_bits_epoch,	// src/main/scala/chisel3/util/Queue.scala:72:14
  output [2:0]  io_count	// src/main/scala/chisel3/util/Queue.scala:72:14
);

  wire [32:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  ram_4x33 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_pc, io_enq_bits_epoch})	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_pc = _ram_ext_R0_data[32:1];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_epoch = _ram_ext_R0_data[0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
