error id: file://<WORKSPACE>/src/device/PSRAM.scala:chisel3/withClockAndReset.apply().
file://<WORKSPACE>/src/device/PSRAM.scala
empty definition using pc, found symbol in pc: chisel3/withClockAndReset.apply().
...
non-local guesses:
	 ...
	 -chisel3/withClockAndReset#
	 -chisel3/withClockAndReset().
	 -chisel3/util/withClockAndReset.
	 -chisel3/util/withClockAndReset#
	 -chisel3/util/withClockAndReset().
	 -freechips/rocketchip/amba/apb/withClockAndReset.
	 -freechips/rocketchip/amba/apb/withClockAndReset#
	 -freechips/rocketchip/amba/apb/withClockAndReset().
	 -freechips/rocketchip/diplomacy/withClockAndReset.
	 -freechips/rocketchip/diplomacy/withClockAndReset#
	 -freechips/rocketchip/diplomacy/withClockAndReset().
	 -freechips/rocketchip/util/withClockAndReset.
	 -freechips/rocketchip/util/withClockAndReset#
	 -freechips/rocketchip/util/withClockAndReset().
	 -withClockAndReset.
	 -withClockAndReset#
	 -withClockAndReset().
	 -scala/Predef.withClockAndReset.
	 -scala/Predef.withClockAndReset#
	 -scala/Predef.withClockAndReset().
offset: 937
...
class psramChisel extends RawModule {
  ...
  withClock@@AndReset(io.sck.asClock, !io.ce_n) {
