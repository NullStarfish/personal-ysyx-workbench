error id: file://<WORKSPACE>/src/device/PSRAM.scala:chisel3/RegInit.apply(+1).
file://<WORKSPACE>/src/device/PSRAM.scala
empty definition using pc, found symbol in pc: chisel3/RegInit.apply(+1).
...
non-local guesses:
	 ...
	 -chisel3/util/RegInit#
	 -chisel3/util/RegInit().
	 -freechips/rocketchip/amba/apb/RegInit.
	 -freechips/rocketchip/amba/apb/RegInit#
	 -freechips/rocketchip/amba/apb/RegInit().
	 -freechips/rocketchip/diplomacy/RegInit.
	 -freechips/rocketchip/diplomacy/RegInit#
	 -freechips/rocketchip/diplomacy/RegInit().
	 -freechips/rocketchip/util/RegInit.
	 -freechips/rocketchip/util/RegInit#
	 -freechips/rocketchip/util/RegInit().
	 -RegInit.
	 -RegInit#
