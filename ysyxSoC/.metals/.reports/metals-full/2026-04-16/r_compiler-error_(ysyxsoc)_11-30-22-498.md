error id: 65E8662953EAE50B86D0E4F3A088ABF4
...
class gpioChisel extends Module {
  ...
  val SETUP =  1
  val ENABLE = 2
  val apbState = RegInit(IDLE.U(2.W))
  val writeMode = RegInit(false.B)
  when (io.in.psel) {
    apbState := SETUP.U
    writeMode := io.in.pwrite
  }
...
scala.collection.mutable.ArrayBuffer.apply(ArrayBuffer.scala:102)
	...
	scala.tools.nsc.typechecker.Typers$Typer.typedParentType(Typers.scala:1681)
