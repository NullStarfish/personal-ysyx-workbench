...
non-local guesses:
	 -chisel3/masic/fpga_io.
	 -chisel3/util/masic/fpga_io.
	 -freechips/rocketchip/diplomacy/masic/fpga_io.
	 -freechips/rocketchip/subsystem/masic/fpga_io.
	 -freechips/rocketchip/util/masic/fpga_io.
	 -freechips/rocketchip/amba/axi4/masic/fpga_io.
	 -freechips/rocketchip/amba/apb/masic/fpga_io.
	 -masic/fpga_io.
	 -scala/Predef.masic.fpga_io.
offset: 5215
...
class ysyxSoCFull(implicit p: Parameters) extends LazyModule {
  ...
  class Impl extends LazyModuleImp(this) with DontTouch {
    ...
    if (Config.hasChipLink) {
      ...
      mfpga.fpga_io.b2c <> masic.f@@pga_io.get.c2b
