error id: file://<WORKSPACE>/src/SoC.scala:chisel3/IO.apply().
file://<WORKSPACE>/src/SoC.scala
empty definition using pc, found symbol in pc: chisel3/IO.apply().
...
non-local guesses:
	 ...
	 -chisel3/util/IO#
	 -chisel3/util/IO().
	 -freechips/rocketchip/diplomacy/IO.
	 -freechips/rocketchip/diplomacy/IO#
	 -freechips/rocketchip/diplomacy/IO().
	 -freechips/rocketchip/subsystem/IO.
	 -freechips/rocketchip/subsystem/IO#
	 -freechips/rocketchip/subsystem/IO().
	 -freechips/rocketchip/util/IO.
	 -freechips/rocketchip/util/IO#
	 -freechips/rocketchip/util/IO().
	 -freechips/rocketchip/amba/axi4/IO.
	 -freechips/rocketchip/amba/axi4/IO#
	 -freechips/rocketchip/amba/axi4/IO().
	 -freechips/rocketchip/amba/apb/IO.
	 -freechips/rocketchip/amba/apb/IO#
	 -freechips/rocketchip/amba/apb/IO().
	 -IO.
	 -IO#
