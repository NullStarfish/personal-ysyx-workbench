error id: file://<WORKSPACE>/src/SoC.scala:ExtBus
file://<WORKSPACE>/src/SoC.scala
empty definition using pc, found symbol in pc: 
semanticdb not found

found definition using fallback; symbol ExtBus
offset: 1214
...
class ysyxSoCASIC(implicit p: Parameters) extends LazyModule {
  ...
  val chiplinkNode = if (Config.hasChipLink) Some(AXI4SlaveNodeGenerator(p(ExtB@@us), ChipLinkParam.allSpace)) else None
