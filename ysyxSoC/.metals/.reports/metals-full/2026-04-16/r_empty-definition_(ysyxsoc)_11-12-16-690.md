error id: file://<WORKSPACE>/src/SoC.scala:chisel3/chiselTypeOf.apply().
file://<WORKSPACE>/src/SoC.scala
empty definition using pc, found symbol in pc: chisel3/chiselTypeOf.apply().
...
non-local guesses:
	 ...
	 -chisel3/chiselTypeOf#
	 -chisel3/chiselTypeOf().
	 -chisel3/util/chiselTypeOf.
	 -chisel3/util/chiselTypeOf#
	 -chisel3/util/chiselTypeOf().
	 -freechips/rocketchip/diplomacy/chiselTypeOf.
	 -freechips/rocketchip/diplomacy/chiselTypeOf#
	 -freechips/rocketchip/diplomacy/chiselTypeOf().
	 -freechips/rocketchip/subsystem/chiselTypeOf.
	 -freechips/rocketchip/subsystem/chiselTypeOf#
	 -freechips/rocketchip/subsystem/chiselTypeOf().
	 -freechips/rocketchip/util/chiselTypeOf.
	 -freechips/rocketchip/util/chiselTypeOf#
	 -freechips/rocketchip/util/chiselTypeOf().
	 -freechips/rocketchip/amba/axi4/chiselTypeOf.
	 -freechips/rocketchip/amba/axi4/chiselTypeOf#
	 -freechips/rocketchip/amba/axi4/chiselTypeOf().
	 -freechips/rocketchip/amba/apb/chiselTypeOf.
	 -freechips/rocketchip/amba/apb/chiselTypeOf#
	 -freechips/rocketchip/amba/apb/chiselTypeOf().
	 -chiselTypeOf.
	 -chiselTypeOf#
	 -chiselTypeOf().
	 -scala/Predef.chiselTypeOf.
	 -scala/Predef.chiselTypeOf#
	 -scala/Predef.chiselTypeOf().
offset: 6153
...
class ysyxSoCFull(implicit p: Parameters) extends LazyModule {
  ...
  class Impl extends LazyModuleImp(this) with DontTouch {
    ...
    val externalPins = IO(new Bundle{
      ...
      val ps2 = chiselTypeO@@f(masic.ps2)
