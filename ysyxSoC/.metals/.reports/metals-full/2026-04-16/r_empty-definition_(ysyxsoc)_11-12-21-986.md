...
non-local guesses:
	 -chisel3/fpga/axi4MasterMemNode/in.
	 -chisel3/fpga/axi4MasterMemNode/in#
	 -chisel3/fpga/axi4MasterMemNode/in().
	 -chisel3/util/fpga/axi4MasterMemNode/in.
	 -chisel3/util/fpga/axi4MasterMemNode/in#
	 -chisel3/util/fpga/axi4MasterMemNode/in().
	 -freechips/rocketchip/diplomacy/fpga/axi4MasterMemNode/in.
	 -freechips/rocketchip/diplomacy/fpga/axi4MasterMemNode/in#
	 -freechips/rocketchip/diplomacy/fpga/axi4MasterMemNode/in().
	 -freechips/rocketchip/subsystem/fpga/axi4MasterMemNode/in.
	 -freechips/rocketchip/subsystem/fpga/axi4MasterMemNode/in#
	 -freechips/rocketchip/subsystem/fpga/axi4MasterMemNode/in().
	 -freechips/rocketchip/util/fpga/axi4MasterMemNode/in.
	 -freechips/rocketchip/util/fpga/axi4MasterMemNode/in#
	 -freechips/rocketchip/util/fpga/axi4MasterMemNode/in().
	 -freechips/rocketchip/amba/axi4/fpga/axi4MasterMemNode/in.
	 -freechips/rocketchip/amba/axi4/fpga/axi4MasterMemNode/in#
	 -freechips/rocketchip/amba/axi4/fpga/axi4MasterMemNode/in().
	 -freechips/rocketchip/amba/apb/fpga/axi4MasterMemNode/in.
	 -freechips/rocketchip/amba/apb/fpga/axi4MasterMemNode/in#
	 -freechips/rocketchip/amba/apb/fpga/axi4MasterMemNode/in().
	 -fpga/axi4MasterMemNode/in.
	 -fpga/axi4MasterMemNode/in#
	 -fpga/axi4MasterMemNode/in().
	 -scala/Predef.fpga.axi4MasterMemNode.in.
	 -scala/Predef.fpga.axi4MasterMemNode.in#
	 -scala/Predef.fpga.axi4MasterMemNode.in().
offset: 5282
...
class ysyxSoCFull(implicit p: Parameters) extends LazyModule {
  ...
  class Impl extends LazyModuleImp(this) with DontTouch {
    ...
    if (Config.hasChipLink) {
      ...
      (fpga.master_mem zip fpga.axi4MasterMemNode.i@@n).map { case (io, (_, edge)) =>
