error id: 255152C20245E97BFD60D6FCE080D5D5
...
class ps2Chisel extends Module {
  ...
  val fifo = new Queue(UInt(8.W), entries = 4)
  ...
  when (fifo.io.deq.valid) {
    io.in.prdata := fifo.io.deq.bits
  }

  fifo.io.deq.ready := io.in.psel && io.in.penable
  ...
  when (!clk_buf) {
    when (cnt === 0.U) {
      ...
      row_buffer := Cat(row_buffer(6, 0), data_buf)
      cnt := cnt + 1.U
    }
  }
...
scala.collection.mutable.ArrayBuffer.apply(ArrayBuffer.scala:102)
	...
	scala.tools.nsc.typechecker.Contexts$Context.$anonfun$withQualifyingImplicitAlternatives$1(Contexts.scala:1084)
	scala.tools.nsc.typechecker.Contexts$Context.scala$tools$nsc$typechecker$Contexts$$importedAccessibleSymbol(Contexts.scala:1259)
	scala.tools.nsc.typechecker.Contexts$Context.collect$1(Contexts.scala:1084)
	scala.tools.nsc.typechecker.Contexts$Context.collectImplicitImports(Contexts.scala:1122)
	scala.tools.nsc.typechecker.Contexts$Context.implicits(Contexts.scala:1185)
	scala.tools.nsc.typechecker.Contexts$Context.implicitssImpl(Contexts.scala:1153)
	scala.tools.nsc.typechecker.Contexts$Context.withOuter$1(Contexts.scala:1143)
	...
	scala.tools.nsc.typechecker.Typers$Typer.adaptExprNotFunMode$1(Typers.scala:1227)
	scala.tools.nsc.typechecker.Typers$Typer.vanillaAdapt$1(Typers.scala:1306)
	...
	scala.tools.nsc.typechecker.Typers$Typer.$anonfun$doTypedApply$13(Typers.scala:3759)
	scala.tools.nsc.typechecker.Typers$Typer.silent(Typers.scala:713)
	scala.tools.nsc.typechecker.Typers$Typer.tryTupleApply$1(Typers.scala:3759)
	scala.tools.nsc.typechecker.Typers$Typer.tryNamesDefaults$1(Typers.scala:3861)
	scala.tools.nsc.typechecker.Typers$Typer.doTypedApply(Typers.scala:3875)
