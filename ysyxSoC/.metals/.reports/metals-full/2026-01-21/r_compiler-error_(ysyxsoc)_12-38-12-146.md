error id: 54557CCAF02477164D5B04AEC42595E2
...
class APBSPI(address: Seq[AddressSet])(implicit p: Parameters) extends LazyModule {
  ...
  class Impl extends LazyModuleImp(this) {
      ...
      override def impl(): Unit = {
        ...
        when (enable) {
          ...
          thread.entry {
            ...
            thread.Global {
              printf(p"APBSPI: XIP: CURRENT PC: ${thread.pc}\n")
              when(thread.pc === 7.U) {
                printf(p"done: ${this.done}, ret: ${this.ret}, pready: ${in.pready}, prdata: ${in.prdata}\n")
              }
            }
          }
        }
    ...
    val xipDoneLatch = RegInit(false.B)

    when (flashHit && in.penable) {

      in.pready := false.B // TAKEN by thread
      
      xipThread.entry {
        val ret =xipThread.Call(xipFunc, in.paddr)
        xipThread.Step {
          in.pready := true.B
          in.prdata := ret
          in.pslverr := false.B
          xipDoneLatch := true.B // 标记这个 APB 事务已经做完了
    ...
    // 当事务结束（psel 掉下去）时，重置锁
    when (!in.penable) {
      xipDoneLatch := false.B
    }

    // 修正输出
    in.pready := xipDoneLatch // 只有在真正完成的那个周期给 1
...
scala.collection.mutable.ArrayBuffer.apply(ArrayBuffer.scala:102)
	...
	scala.tools.nsc.typechecker.Typers$Typer.typedTypeBoundsTree$1(Typers.scala:6106)
	scala.tools.nsc.typechecker.Typers$Typer.typed1(Typers.scala:6156)
	scala.tools.nsc.typechecker.Typers$Typer.typed(Typers.scala:6261)
	scala.tools.nsc.typechecker.Typers$Typer.typedType(Typers.scala:6445)
	scala.tools.nsc.typechecker.Typers$Typer.typedType(Typers.scala:6448)
	scala.tools.nsc.typechecker.Namers$Namer.typeDefSig(Namers.scala:1813)
	scala.tools.nsc.typechecker.Namers$Namer.memberSig(Namers.scala:1954)
	...
	scala.reflect.internal.ExistentialsAndSkolems$Deskolemizer$1.complete(ExistentialsAndSkolems.scala:41)
	scala.reflect.internal.Symbols$Symbol.completeInfo(Symbols.scala:1566)
	scala.reflect.internal.Symbols$Symbol.info(Symbols.scala:1538)
	scala.reflect.internal.Symbols$TypeSkolem.typeParams(Symbols.scala:3336)
	scala.tools.nsc.typechecker.Typers$Typer.adaptType$1(Typers.scala:1036)
	scala.tools.nsc.typechecker.Typers$Typer.vanillaAdapt$1(Typers.scala:1277)
	...
	scala.tools.nsc.typechecker.Namers$LockingTypeCompleter.complete$(Namers.scala:2098)
	scala.tools.nsc.typechecker.Namers$TypeCompleterBase.complete(Namers.scala:2093)
	scala.tools.nsc.typechecker.Namers$PolyTypeCompleter.completeImpl(Namers.scala:2133)
	scala.tools.nsc.typechecker.Namers$LockingTypeCompleter.complete(Namers.scala:2100)
	scala.tools.nsc.typechecker.Namers$LockingTypeCompleter.complete$(Namers.scala:2098)
	scala.tools.nsc.typechecker.Namers$PolyTypeCompleter.complete(Namers.scala:2112)
	scala.reflect.internal.Symbols$Symbol.completeInfo(Symbols.scala:1566)
	scala.reflect.internal.Symbols$Symbol.info(Symbols.scala:1538)
