error id: B6CA4D4E7D7D0D3C11E6DA30342E018A
...
class APBSPI(address: Seq[AddressSet])(implicit p: Parameters) extends LazyModule {
  ...
  class Impl extends LazyModuleImp(this) {
    ...
    xip.io.req.valid = (state === sXIP)
    xip.io.req.bits = in.paddr
    xip.io.resp.valid
...
scala.collection.mutable.ArrayBuffer.apply(ArrayBuffer.scala:102)
	...
	scala.tools.nsc.typechecker.NamesDefaults.blockWithoutQualifier$1(NamesDefaults.scala:216)
	scala.tools.nsc.typechecker.NamesDefaults.baseFunBlock$1(NamesDefaults.scala:278)
	scala.tools.nsc.typechecker.NamesDefaults.transformNamedApplication(NamesDefaults.scala:392)
	scala.tools.nsc.typechecker.NamesDefaults.transformNamedApplication$(NamesDefaults.scala:135)
	scala.meta.internal.pc.MetalsGlobal$MetalsInteractiveAnalyzer.transformNamedApplication(MetalsGlobal.scala:85)
	scala.tools.nsc.typechecker.Typers$Typer.tryNamesDefaults$1(Typers.scala:3829)
