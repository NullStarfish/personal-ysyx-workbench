error id: 59CD877D427F82FFCCBF7FCEE25B3660
file://<WORKSPACE>/src/device/SPI.scala
### java.lang.IndexOutOfBoundsException: -1 is out of bounds (min 0, max 5)
...
class APBSPI(address: Seq[AddressSet])(implicit p: Parameters) extends LazyModule {
  ...
  class Impl extends LazyModuleImp(this) {
    ...
    val xip = new XIP
    val xipDone = Bool()
    val flashData = UInt(32.W)


    re@@
    (xipDone, flashData) := xip.execute()
