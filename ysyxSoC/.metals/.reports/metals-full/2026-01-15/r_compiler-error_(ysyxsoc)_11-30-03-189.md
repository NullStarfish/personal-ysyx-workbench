error id: DE943BC6A526F6979FE4C21107CAB5FA
...
class APBSPI(address: Seq[AddressSet])(implicit p: Parameters) extends LazyModule {
  ...
  class Impl extends LazyModuleImp(this) {
    ...
    // WRONG !!!! := only recognize the last driven source
    ...
    xipStart := flashHit && (state === sXIP) //why we need state === sXIP
