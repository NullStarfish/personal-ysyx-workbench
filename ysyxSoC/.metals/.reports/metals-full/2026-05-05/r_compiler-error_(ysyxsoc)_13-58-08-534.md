...
### scala.ScalaReflectionException: value writeEn is not a method
...
class vgaChisel extends Module {
  ...
  val readEn = io.in.psel && !io.in.penable && !io.in.pwrite
  io.in.prdata := frame_buf.read(io.in.paddr, readEn)


  val writeEn  = io.in.psel && io.in.penable &&
