...
module PSRAM_READER (
    ...
    wire [7:0]  FINAL_COUNT = qpi_mode ? (8'd13 + size*2) : (8'd19 + size*2); // was 27: Always read 1 word
    wire [7:0]  SAMPLE_START = qpi_mode ? 8'd14 : 8'd20;
...
module PSRAM_WRITER (
    ...
    wire[7:0]        FINAL_COUNT = qpi_mode ? (8'd7 + size*2) : (8'd13 + size*2);
